use super::{get_tokens, Lex, Op, Tkn};
...
fn object_fields() {
    assert_tokens!(
        ...
        vec![
            ...
            Lex { token: Tkn::Op(Op::Assign), line: 0 },
            Lex { token: Tkn::LBrace, line: 0 },
...
fn small_function() {
    assert_tokens!(
        ...
        vec![
            ...
            Lex { token: Tkn::Op(Op::Assign), line: 1 },
            Lex { token: Tkn::LBrace, line: 1 },
            Lex { token: Tkn::Ident("a"), line: 2 },
            Lex { token: Tkn::Colon, line: 2 },
            Lex { token: Tkn::Ident("a"), line: 2 },
...
fn tiny_program() {
    assert_tokens!(
        ...
        vec![
            ...
            Lex { token: Tkn::Ident("b"), line: 2 },
            Lex { token: Tkn::Op(Op::Assign), line: 2 },
...
fn if_else() {
    assert_tokens!(
        ...
        vec![
            ...
            Lex { token: Tkn::Op(Op::Assign), line: 4 },
...
fn r#for() {
    assert_tokens!(
        ...
        vec![
            ...
            Lex { token: Tkn::Op(Op::AssignAdd), line: 2 },
...
fn update_assign() {
    assert_tokens!(
        ...
        vec![
            Lex { token: Tkn::Ident("a"), line: 0 },
            Lex { token: Tkn::Op(Op::AssignAdd), line: 0 },
            Lex { token: Tkn::Num("1"), line: 0 },
            Lex { token: Tkn::Semicolon, line: 0 },
            Lex { token: Tkn::Ident("b"), line: 1 },
            Lex { token: Tkn::Op(Op::AssignSub), line: 1 },
            Lex { token: Tkn::Num("1"), line: 1 },
            Lex { token: Tkn::Semicolon, line: 1 },
            Lex { token: Tkn::Ident("c"), line: 2 },
            Lex { token: Tkn::Op(Op::AssignMul), line: 2 },
            Lex { token: Tkn::Num("2"), line: 2 },
            Lex { token: Tkn::Semicolon, line: 2 },
            Lex { token: Tkn::Ident("d"), line: 3 },
            Lex { token: Tkn::Op(Op::AssignDiv), line: 3 },
